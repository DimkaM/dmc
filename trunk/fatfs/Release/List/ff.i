...
if (wsect != sector) { 
if (fs->wflag) { 
 { dio_par.drv= fs->drv ; dio_par.buf= fs->win ; dio_par.sec=& wsect ; dio_par.num= 1 ;} ;
...
if (sector) {
 { dio_par.drv= fs->drv ; dio_par.buf= fs->win ; dio_par.sec=& sector ; dio_par.num= 1 ;} ;
if (disk_read() != RES_OK)
return FR_DISK_ERR;
fs->winsect = sector;
}
 ...
 *(DWORD*)(BYTE*)( fs->win+ 492 )=(DWORD)( fs->last_clust ) ;
 ...
 { dio_par.drv= fs->drv ; dio_par.buf= fs->win ; dio_par.sec=& fs->fsi_sector ; dio_par.num= 1 ;} ;
disk_write();
fs->fsi_flag = 0;
}
...
return  (DWORD)(*(DWORD*)(BYTE*)( p ))  & 0x0FFFFFFF;
}
...
if (!(dir[ 11 ] &  0x08 ) && !memcmp(dir, dj->fn, 11)) 
break;
res = dir_next(dj, 0); 
} while (res == FR_OK);
...
{  { dio_par.drv= fs->drv ; dio_par.buf= fs->win ; dio_par.sec=& sect ; dio_par.num= 1 ;} ;
if (disk_read() != RES_OK) 
return 3;
...
stat = disk_initialize(fs->drv,fs->win); 
if (stat &  0x01 ) 
return FR_NOT_READY; 
if (chk_wp && (stat &  0x04 )) 
return FR_WRITE_PROTECTED;
...
tbl = &fs->win[ 446  + fs->part *  16 ]; 
if (tbl[4]) { 
bsect =  (DWORD)(*(DWORD*)(BYTE*)( &tbl[8] )) ; 
...
if ( (WORD)(*(WORD*)(BYTE*)( fs->win+ 11 ))  !=  512U ) 
...
if (fmt ==  3 ) {
fs->fsi_flag = 0;
fs->fsi_sector = bsect +  (WORD)(*(WORD*)(BYTE*)( fs->win+ 48 )) ;
 { dio_par.drv= fs->drv ; dio_par.buf= fs->win ; dio_par.sec=& fs->fsi_sector ; dio_par.num= 1 ;} ;
if (disk_read() == RES_OK &&
 (WORD)(*(WORD*)(BYTE*)( fs->win+ 510 ))  == 0xAA55 &&
...
cl = LD_CLUST(dir); 
 { *(WORD*)(BYTE*)( dir + 26 )=(WORD)( 0 ) ; *(WORD*)(BYTE*)( dir + 20 )=(WORD)( (DWORD) 0 >>16 ) ;} ; 
dj.fs->wflag = 1;
if (cl) { 
dw = dj.fs->winsect;
...
cc = fp->fs->csize - csect;
 { dio_par.drv= fp->fs->drv ; dio_par.buf= rbuff ; dio_par.sec=& sect ; dio_par.num= (BYTE)cc ;} ;
if (disk_read() != RES_OK)
 { fp->flag |= 0x80 ; return FR_DISK_ERR ; } ;
if ((fp->flag &  0x40 ) && fp->dsect - sect < cc)
memcpy(rbuff + ((fp->dsect - sect) *  512U ), fp->buf,  512U );
rcnt =  512U  * cc; 
continue;
}
if (fp->dsect != sect) { 
if (fp->flag &  0x40 ) { 
 { dio_par.drv= fp->fs->drv ; dio_par.buf= fp->buf ; dio_par.sec=& fp->dsect ; dio_par.num= 1 ;} ;
if (disk_write() != RES_OK)
 { fp->flag |= 0x80 ; return FR_DISK_ERR ; } ;
fp->flag &= ~ 0x40 ;
}

 { dio_par.drv= fp->fs->drv ; dio_par.buf= fp->buf ; dio_par.sec=& sect ; dio_par.num= 1 ;} ;
if (disk_read() != RES_OK) 
 { fp->flag |= 0x80 ; return FR_DISK_ERR ; } ;
}
fp->dsect = sect;
...
memcpy(rbuff, &fp->buf[fp->fptr %  512U ], rcnt); 
}
...
if (csect + cc > fp->fs->csize) 
cc = fp->fs->csize - csect;
 { dio_par.drv= fp->fs->drv ; dio_par.buf= wbuff ; dio_par.sec=& sect ; dio_par.num= (BYTE)cc ;} ;
if (disk_write() != RES_OK)
 { fp->flag |= 0x80 ; return FR_DISK_ERR ; } ;
if (fp->dsect - sect < cc) { 
memcpy(fp->buf, wbuff + ((fp->dsect - sect) *  512U ),  512U );
fp->flag &= ~ 0x40 ;
}
wcnt =  512U  * cc; 
continue;
...
memcpy(&fp->buf[fp->fptr %  512U ], wbuff, wcnt); 
fp->flag |=  0x40 ;
}
 ...
 *(DWORD*)(BYTE*)( dir+ 28 )=(DWORD)( fp->fsize ) ; 
 { *(WORD*)(BYTE*)( dir + 26 )=(WORD)( fp->sclust ) ; *(WORD*)(BYTE*)( dir + 20 )=(WORD)( (DWORD) fp->sclust >>16 ) ;} ; 
get_fattime(&tim); 
 *(DWORD*)(BYTE*)( dir+ 22 )=(DWORD)( tim ) ;
fp->flag &= ~ 0x20 ;
fp->fs->wflag = 1;
res = sync(fp->fs);
}
...
{
if (drv >=  2 ) return FR_INVALID_DRIVE;
...
fp->flag &= ~ 0x40 ;
 ...
 { dio_par.drv= fp->fs->drv ; dio_par.buf= fp->buf ; dio_par.sec=& nsect ; dio_par.num= 1 ;} ;
if (disk_read() != RES_OK) 
 { fp->flag |= 0x80 ; return FR_DISK_ERR ; } ;
fp->dsect = nsect;
}
...
if (fat ==  2 ) {
if ( (WORD)(*(WORD*)(BYTE*)( p ))  == 0) n++;
p += 2; i -= 2;
} else {
if (( (DWORD)(*(DWORD*)(BYTE*)( p ))  & 0x0FFFFFFF) == 0) n++;
p += 4; i -= 4;
}
} while (--clst);
}
...
dir[ 11 ] =  0x10 ;
 *(DWORD*)(BYTE*)( dir+ 22 )=(DWORD)( tim ) ;
 { *(WORD*)(BYTE*)( dir + 26 )=(WORD)( dcl ) ; *(WORD*)(BYTE*)( dir + 20 )=(WORD)( (DWORD) dcl >>16 ) ;} ;
memcpy(dir+ 32 , dir,  32 ); 
dir[33] = '.'; pcl = dj.sclust;
if (dj.fs->fs_type ==  3  && pcl == dj.fs->dirbase)
pcl = 0;
 { *(WORD*)(BYTE*)( dir+ 32 + 26 )=(WORD)( pcl ) ; *(WORD*)(BYTE*)( dir+ 32 + 20 )=(WORD)( (DWORD) pcl >>16 ) ;} ;
 ...
 *(WORD*)(BYTE*)( dir+ 22 )=(WORD)( fno->ftime ) ;
 *(WORD*)(BYTE*)( dir+ 24 )=(WORD)( fno->fdate ) ;
dj.fs->wflag = 1;
res = sync(dj.fs);
}
}
...
dw = (djn.fs->fs_type ==  3  && djn.sclust == djn.fs->dirbase) ? 0 : djn.sclust;
 { *(WORD*)(BYTE*)( dir + 26 )=(WORD)( dw ) ; *(WORD*)(BYTE*)( dir + 20 )=(WORD)( (DWORD) dw >>16 ) ;} ;
djn.fs->wflag = 1;
}
}
}
