...
void line_atm7_16(unsigned char *dst, unsigned char *src, unsigned *tab0, unsigned char *font, int src_offset)
{
...
void line_atm7_32(unsigned char *dst, unsigned char *src, unsigned *tab0, unsigned char *font, int src_offset)
{
...
// EvoTextmode DimkaM
void rend_atm7(unsigned char *dst, unsigned pitch, int y, int Offset)
{
   ...
   if (temp.scy > 200) 
    ...
    if (conf.fast_sl) {
        ...
        {
        case 8:
            line_atm7_8 (dst2, temp.base, t.zctab8 [0], fontatm2 + v*0x100, Offset); 
            break;
        case 16:
            line_atm7_16(dst2, temp.base, t.zctab16[0], fontatm2 + v*0x100, Offset); 
            break;
        case 32:
            line_atm7_32(dst2, temp.base, t.zctab32[0], fontatm2 + v*0x100, Offset); 
            break;
        }
    } else {
        dst2 += 2*y*pitch;
        ...
        case 8:
            line_atm7_8 (dst2, temp.base, t.zctab8 [0], fontatm2 + v*0x100, Offset); 
            dst2 += pitch;
            line_atm7_8 (dst2, temp.base, t.zctab8 [1], fontatm2 + v*0x100, Offset);
            break;
        case 16:
            line_atm7_16(dst2, temp.base, t.zctab16[0], fontatm2 + v*0x100, Offset); 
            dst2 += pitch;
            line_atm7_16(dst2, temp.base, t.zctab16[1], fontatm2 + v*0x100, Offset);
            break;
        case 32:
            line_atm7_32(dst2, temp.base, t.zctab32[0], fontatm2 + v*0x100, Offset); 
            dst2 += pitch;
            line_atm7_32(dst2, temp.base, t.zctab32[1], fontatm2 + v*0x100, Offset);
            break;
        }
    }
}
